...
interface UiPosters {
    fun showPostersMovie(moviePosters: List<Poster>, homeFlowViewModel: HomeFlowViewModel)
    fun showPostersTvSeries(tvSeriesPosters: List<Poster>, homeFlowViewModel: HomeFlowViewModel)
    fun showException(exception: String, mainActivityViewModel: MainActivityViewModel)
    fun showBootAutoStartAlertDialog(ma: MainActivity)
}