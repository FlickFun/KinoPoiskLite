...
class UiListCinemaFavoriteImp @Inject constructor() : UiListCinemaFavorite {

    override fun showFavoriteMovie(
        moviePosters: List<Poster>,
        favoriteViewModel: FavoriteViewModel
    ) = favoriteViewModel.setMovieToLifeData(moviePosters)

    override fun showFavoriteTvSeries(
        tvSeriesPosters: List<Poster>,
        favoriteViewModel: FavoriteViewModel
    ) = favoriteViewModel.setTvSeriesToLifeData(tvSeriesPosters)
}
